...
<div class="row justify-content-center align-items-center pt-5" style="min-height:75vh;">
    ...
    <div class="col-12 col-md-9 d-flex justify-content-center">
        <x-card classes="card shadow-sm mx-auto" style="max-width:760px; width:100%;" body-classes="card-body p-4 d-flex flex-column" body-style="min-height:420px;">
                <!-- Top: title + intro -->
                <div>
